...
describe("GET /api/users", () => {
  it("should return a 403 status code, indicating users cannot access the list of all users", async () => {
  ...
  it("should return a 200 status code, indicating an admin successfully retrieves the list of all users", async () => {
